    ...
    <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mb-8">
      <Card className="lg:col-span-2">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <div className="space-y-0.5">
            <CardTitle className="text-base font-medium">Görev Trendleri</CardTitle>
            <CardDescription>Günlük görev durumu değişiklikleri</CardDescription>
          </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <div className="space-y-0.5">
            ...
            <CardDescription>Proje durumları</CardDescription>
          </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <div className="space-y-0.5">
            ...
            <CardDescription>Görev önceliği dökümü</CardDescription>
          </div>
        </CardHeader>
      ...
      <Card className="lg:col-span-2">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <div className="space-y-0.5">
            <CardTitle className="text-base font-medium">
              Çalışma Alanı Verimliliği
            </CardTitle>
            <CardDescription>Projeye göre görev tamamlama</CardDescription>
          </div>
